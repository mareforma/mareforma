...
* :func:`rebuild_cache` is called when :func:`is_cache_stale` returns
  ...
  after the full chain has been replayed. A torn commit on the insert
  and delete paths moves the claim count, so the next attach rebuilds;
  an in-place supports edit moves no count and is not caught here.
