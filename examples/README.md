...
|---|---------|---------------|
| 01 | [API Walkthrough](01_api_walkthrough/) | Full API: open(), assert_claim(), query(), idempotency, what two agents converging looks like on the record, validate(), anti-patterns |
...
| 03 | [Documented Contestation](03_documented_contestation/) | Agent challenges a reviewed finding with stronger methodology; both coexist in the graph |
