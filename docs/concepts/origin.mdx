...
[Findings](/concepts/findings)). The stored `support_level` ladder those
examples used to name is gone, column and all. Origin was always orthogonal to
it.
...
<AccordionGroup>
  ...
  <Accordion title="DERIVED">
    Explicitly built on other claims already in the graph.
...
prior_id = "3f8a1b2c-..."  # a prior claim
