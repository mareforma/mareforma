...
and it is being removed whole. The public labels and the `query(min_support=...)`
filter are gone; the stored column and the promotion machinery go with the
schema step. Origin is orthogonal to all of it.
