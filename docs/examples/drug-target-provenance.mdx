...
```python
result = _run_medea_fork(disease="rheumatoid arthritis", cell_type="CD4")
...
```bash
python 05_drug_target_provenance.py --install   # install packages
python 05_drug_target_provenance.py --data      # ~21 GB MedeaDB download
