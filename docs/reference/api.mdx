...
Substrate-owned (writer in the substrate):
...
Substrate-derived classification. Deterministically derives `ANALYTICAL` vs `INFERRED` from a static source-code profile plus dynamic runtime-log templates.
