...
### `assert_claim(text, *, classification, generated_by, supports, contradicts, source_name, idempotency_key, status, artifact_hash, evidence, seed, signer, predicate_payload, original_signature_bundle, grounding_sensor, observed_grounding)`
